...
/**
 * Componente de administración de categorías de cliente.
 * Permite agregar, editar, eliminar y reordenar categorías personalizadas.
 */
export function CustomerCategorySettings() {
  const {
    categories,
    addCategory,
    updateCategory,
  ...
  const handleStartEdit = (cat: CustomerCategoryConfig) => {
    ...
    // Extraer color del dot class: "bg-slate-500" → "slate"
    ...
    <>
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-base">Categorías de Clientes</CardTitle>
                <CardDescription>
        ...
        <CardContent className="space-y-4">
          {/* Info */}
          <div className="flex items-start gap-2 rounded-lg border border-blue-200 dark:border-blue-800/50 bg-blue-50/50 dark:bg-blue-900/10 p-3">
            <Info className="h-4 w-4 text-blue-500 mt-0.5 shrink-0" />
            <p className="text-xs text-blue-700 dark:text-blue-300">
              Estas categorías se usan en formularios, filtros y reportes del módulo de Clientes.
              Cada organización puede definir sus propias clasificaciones según su modelo comercial.
            </p>
          </div>
            ...
            {categories.map((cat) => {
              ...
              return (
                ...
                >
                  ...
                  <div className={cn("h-3.5 w-3.5 rounded-full shrink-0", cat.color)} />
